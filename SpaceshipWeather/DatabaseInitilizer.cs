...
public class DatabaseInitilizer
{
    ...
    private async Task CreateInsertSnapshotBatchStoredProcedure(SqlConnection connection)
    {
        const string createSnapshotBatchTableCommand = """
                                                           ...
                                                           BEGIN
                                                               ...
                                                               AS
                                                               BEGIN
                                                                   INSERT INTO WeatherSnapshot ([TimeStamp], Temperature, RelativeHumidity, WindSpeed,
                                                                                                WeatherForecastId)
